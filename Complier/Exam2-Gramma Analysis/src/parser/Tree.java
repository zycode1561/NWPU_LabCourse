    ...
    public Tree(BufferedReader bufferedReader, int line, FileWriter writer,String fileName) throws IOException {
        ...
        while((currentLine = bf.readLine()) != null){
            ...
            if(currentLine.startsWith("class")){
                Goal t = new Goal(bf, lineNum, writer, fileName);
                child.add(t);
                //更新bf读取位置和lineNum
                bf = t.getBf();
                lineNum = t.getLineNum();
            }else{
                System.out.println("1>>>ERROR APPEARED IN LINE " + lineNum + " : STATEMENT INCOMPLETE" + CRLF);
                writer.write("ERROR APPEARED IN LINE " + lineNum + " : STATEMENT INCOMPLETE" + CRLF);
                handleError();
            }
        }
    }
...
//        String printNode = "";
//        if(child.peekFirst() != null){
//            printNode = child.peekFirst().toString(1);
//        }
